...
private:
    ...
    float hitPosInStrips(const CSCRecHit2D* h) const;
    float fit_r_phi(CLHEP::HepMatrix points, int layer) const;
    float fitX(CLHEP::HepMatrix points, CLHEP::HepMatrix errors, float &chi2_str);
    float fit_sp(CLHEP::HepMatrix points, CLHEP::HepMatrix errors, int layer);
    float fitX_ir(CLHEP::HepMatrix points, CLHEP::HepMatrix errors, int ir, float &chi2_str);
    float fitX_ir2(CLHEP::HepMatrix points, CLHEP::HepMatrix errors, int ir, int ir2, float &chi2_str);
